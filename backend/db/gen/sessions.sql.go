...
SELECT users.id, users.oauth_provider, users.oauth_subject, users.display_name, users.code, users.password_hash, users.email, users.status, users.is_admin, users.created_at
FROM sessions
